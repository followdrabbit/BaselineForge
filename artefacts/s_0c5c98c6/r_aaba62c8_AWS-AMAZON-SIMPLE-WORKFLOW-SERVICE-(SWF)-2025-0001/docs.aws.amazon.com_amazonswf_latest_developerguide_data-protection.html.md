# Processed Content from URL: {'REFERENCE': 'https://docs.aws.amazon.com/amazonswf/latest/developerguide/data-protection.html'}

[](/pdfs/amazonswf/latest/developerguide/swf-dg.pdf#data-protection "Open
PDF")
...
to data protection in Amazon Simple Workflow Service. As described in this
...
SWF or other AWS services using the console, API, AWS CLI, or AWS SDKs. Any
