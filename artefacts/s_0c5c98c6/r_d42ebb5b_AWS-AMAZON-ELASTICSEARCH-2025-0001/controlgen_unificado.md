...
[
  {
    ...
    "Description": "Ensure encryption at rest is enabled for all Elasticsearch domains using AWS KMS with AES-256 keys.",
  ...
  },
  {
    ...
    "Description": "Ensure that Elasticsearch domains are not publicly accessible and are hosted within a VPC.",
    "Applicability": "All Elasticsearch domains in AWS",
  ...
  },
  {
    ...
    "Description": "Configure Elasticsearch domains to use node-to-node encryption to secure intra-cluster communications.",
  ...
  },
  {
    ...
    "Description": "Ensure error logging is enabled for Elasticsearch domains by configuring them to publish logs to CloudWatch Logs.",
    "Applicability": "All Elasticsearch domains in AWS",
    ...
    "Default Behavior / Limitations": "Only 'error' log type is considered in this context.",
  ...
  },
  {
    ...
    "Description": "Ensure audit logging is enabled to track all access and modifications in Elasticsearch domains, sending them to CloudWatch Logs.",
    "Applicability": "All Elasticsearch domains in AWS",
  ...
  },
  {
    ...
    "Description": "Ensure Elasticsearch domains are configured with at least three data nodes for high availability.",
  ...
  },
  {
    ...
    "Description": "Elasticsearch domains should be configured with at least three dedicated master nodes for improved fault tolerance.",
  ...
  },
  {
    ...
    "Description": "Elasticsearch domains should be configured to use the latest AWS TLS policies for secure connections.",
    "Applicability": "All Elasticsearch domains exposed to networks",
    "Security Risk": "Using outdated TLS policies could expose communication to man-in-the-middle (MITM) attacks, risking data confidentiality and integrity.",
  ...
  },
  {
    ...
    "Description": "Apply appropriate resource tags to Elasticsearch domains for better management, billing, and identification.",
